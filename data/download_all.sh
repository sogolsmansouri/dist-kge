...
CURL_OPTS="-L -f --retry 5 --retry-delay 2 --connect-timeout 20"
...
if [ ! -d "$BASEDIR/toy" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/toy.tar.gz
    tar xvf toy.tar.gz
else
...
if [ ! -d "$BASEDIR/fb15k" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/fb15k.tar.gz
...
if [ ! -d "$BASEDIR/fb15k-237" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/fb15k-237.tar.gz
...
if [ ! -d "$BASEDIR/wn18" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/wn18.tar.gz
    tar xvf wn18.tar.gz
    cd wn18
    case "$(uname -s)" in
        CYGWIN*|MINGW32*|MSYS*)
...
if [ ! -d "$BASEDIR/wnrr" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/wnrr.tar.gz
    tar xvf wnrr.tar.gz
else
...
if [ ! -d "$BASEDIR/dbpedia50" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/dbpedia50.tar.gz
...
if [ ! -d "$BASEDIR/dbpedia500" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/dbpedia500.tar.gz
...
if [ ! -d "$BASEDIR/db100k" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/db100k.tar.gz
...
if [ ! -d "$BASEDIR/yago3-10" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/yago3-10.tar.gz
...
if [ ! -d "$BASEDIR/wikidata5m" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/wikidata5m.tar.gz
...
if [ ! -d "$BASEDIR/kinship" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/kinship.tar.gz
...
if [ ! -d "$BASEDIR/nations" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/nations.tar.gz
...
if [ ! -d "$BASEDIR/umls" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/umls.tar.gz
    tar xvf umls.tar.gz
else
...
if [ ! -d "$BASEDIR/wn11" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O https://www.uni-mannheim.de/media/Einrichtungen/dws/pi1/kge_datasets/wn11.tar.gz
    tar xvf wn11.tar.gz
...
if [ ! -d "$BASEDIR/freebase" ]; then
    ...
    cd $BASEDIR
    curl $CURL_OPTS -O http://web.informatik.uni-mannheim.de/pi1/kge-datasets/freebase.tar.gz
